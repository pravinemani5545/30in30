...
import type { ContactWithSuggestions, ContactStatus } from "@/types/day2";
import { EnrichmentPanel } from "@/components/day2/EnrichmentPanel";
import { NotesEditor } from "@/components/day2/NotesEditor";
import { StatusSelector } from "@/components/day2/StatusSelector";
import { SkeletonEnrichment } from "@/components/day2/SkeletonEnrichment";
import { EmptyState } from "@/components/day2/EmptyState";
...
export function ContactDetail({
  ...
  async function handleStatusChange(newStatus: ContactStatus) {
    ...
    try {
      const res = await fetch(`/api/day2/contacts/${contact.id}`, {
        method: "PATCH",
