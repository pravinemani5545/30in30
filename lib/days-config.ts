...
export const DAYS: DayConfig[] = [
  ...
  { day: 20, slug: "day20", name: "ReplyClassifier", tagline: "Classify cold email replies into buckets with AI", status: "coming-soon", tags: [] },
  { day: 21, slug: "day21", name: "BRollFinder", tagline: "AI-powered B-roll search from text descriptions", status: "coming-soon", tags: [] },
  { day: 22, slug: "day22", name: "CampaignDashboard", tagline: "Unified campaign analytics across platforms", status: "coming-soon", tags: [] },
  { day: 23, slug: "day23", name: "VideoIdeaEngine", tagline: "Generate YouTube video ideas from trending topics", status: "coming-soon", tags: [] },
  { day: 24, slug: "day24", name: "StripeCheckoutKit", tagline: "One-click Stripe checkout for digital products", status: "coming-soon", tags: [] },
  { day: 25, slug: "day25", name: "AgentOrchestrator", tagline: "Multi-agent task orchestration with handoffs", status: "coming-soon", tags: [] },
  { day: 26, slug: "day26", name: "OnboardingWizard", tagline: "AI-generated onboarding flows from product context", status: "coming-soon", tags: [] },
  { day: 27, slug: "day27", name: "DocGenerator", tagline: "Auto-generate API docs from codebase analysis", status: "coming-soon", tags: [] },
  { day: 28, slug: "day28", name: "FunnelSimulator", tagline: "Simulate conversion funnels with AI predictions", status: "coming-soon", tags: [] },
  { day: 29, slug: "day29", name: "FullPipelineDemo", tagline: "End-to-end sales pipeline connecting all 28 tools", status: "coming-soon", tags: [] },
  { day: 30, slug: "day30", name: "YouTubeAISuite", tagline: "Unified YouTube publishing suite — the Month 6 preview", status: "coming-soon", tags: [] },
];
