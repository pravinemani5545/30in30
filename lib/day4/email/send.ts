...
import DigestEmail from "@/components/day4/DigestEmail";
import type { Subscriber, SummarizedStory } from "@/types/day4";
...
export async function sendDigestEmail(
  ...
  const unsubscribeUrl = `${appUrl}/api/day4/unsubscribe?token=${subscriber.unsubscribe_token}`;
