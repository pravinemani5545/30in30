...
import SubscriberForm from "@/components/day4/SubscriberForm";
import SubscriberList from "@/components/day4/SubscriberList";
import LastDigestPreview from "@/components/day4/LastDigestPreview";
import DigestHistory from "@/components/day4/DigestHistory";
import ManualTriggerButton from "@/components/day4/ManualTriggerButton";
  ...
  const refreshData = useCallback(async () => {
    try {
      const [subsRes, runsRes] = await Promise.all([
        fetch("/api/day4/subscribers"),
        fetch("/api/day4/digest/history"),
      ]);
      if (subsRes.ok) {
