...
import { UrlInputForm } from "@/components/day3/UrlInputForm";
import { GenerationStatus } from "@/components/day3/GenerationStatus";
import { TweetGrid } from "@/components/day3/TweetGrid";
import { EmptyState } from "@/components/day3/EmptyState";
import { HistorySidebar } from "@/components/day3/HistorySidebar";
import { useGenerate } from "@/hooks/day3/useGenerate";
...
export function DashboardClient() {
  ...
  async function handleSelectFromHistory(id: string) {
    ...
    try {
      const res = await fetch(`/api/day3/generations/${id}`);
