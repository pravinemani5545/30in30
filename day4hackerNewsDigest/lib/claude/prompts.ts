...
For every post, write exactly 2 sentences summarising it, then score its relevance for this audience on a scale of 1 to 10.
...
- The reason should be one short phrase, e.g., "Directly applicable LLM optimization technique"`;
